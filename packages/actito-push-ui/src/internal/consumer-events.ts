 ...
 *     - `notification`: The {@link ActitoNotification} that will be presented.
 ...
 *  - The callback receives a single parameter:
 *     - `notification`: The {@link ActitoNotification} presented.
 ...
 *  - The callback receives a single parameter:
 *     - `notification`: The {@link ActitoNotification} that finished presenting.
 ...
 *  - The callback receives a single parameter:
 *     - `notification`: The {@link ActitoNotification} that failed to present.
 ...
 *     - `notification`: The {@link ActitoNotification} containing the action.
 *     - `action`: The {@link ActitoNotificationAction} that will be executed.
 ...
 *  - The callback receives the following parameters:
 *     - `notification`: The {@link ActitoNotification} containing the action.
 *     - `action`: The {@link ActitoNotificationAction} that was executed.
 ...
 *  - The callback receives the following parameters:
 *     - `notification`: The {@link ActitoNotification} containing the action.
 *     - `action`: The {@link ActitoNotificationAction} that failed to execute.
...
export function notifyNotificationWillPresent(notification: ActitoNotification) {
...
export function notifyNotificationPresented(notification: ActitoNotification) {
...
export function notifyNotificationFinishedPresenting(notification: ActitoNotification) {
...
export function notifyNotificationFailedToPresent(notification: ActitoNotification) {
