...
export type OnLocationUpdatedCallback = (location: ActitoLocation) => void;
 ...
 *     - `location`: The {@link ActitoLocation} instance representing the current location.
...
export function notifyLocationUpdated(location: ActitoLocation) {
