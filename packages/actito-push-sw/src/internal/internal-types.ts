export type WorkerNotification = ActitoWorkerNotification | UnknownWorkerNotification;

// eslint-disable-next-line @typescript-eslint/no-explicit-any
export type UnknownWorkerNotification = any;

export interface ActitoWorkerNotification {
...
export interface ActitoWorkerNotificationAttachment {
  readonly mimeType: string;
  readonly uri: string;
}

export interface ActitoWorkerNotificationAction {
  readonly _id: string;
