...
export function showMessage(message: ActitoInAppMessage) {
...
function presentAction(message: ActitoInAppMessage, type: ActionType) {
  let action: ActitoInAppMessageAction | undefined;
